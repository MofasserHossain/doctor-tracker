...
This version has breaking changes: APIs, conventions, and file structure may differ from older projects. Read the relevant guide in `node_modules/next/dist/docs/` from this directory before writing framework-sensitive code. Heed deprecation notices.
